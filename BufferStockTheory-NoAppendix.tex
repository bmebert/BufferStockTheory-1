...
\begin{verbatimwrite}{\EqDir/DBCparts}
  \begin{gather}\label{eq:DBCparts}
    \begin{align}
...
\begin{gather}\label{eq:RICimplies}
  \begin{align}
...
\begin{gather} \label{eq:lowerltupper}
  \begin{align}
...
\begin{gather}\label{eq:balgrostable}
  \begin{align}
...
\begin{verbatimwrite}{\EqDir/TheoremMSSBalExists}
  \begin{theorem}\label{thm:MSSBalExists}
    ...
    \begin{gather}\label{eq:stabilityStE}
      \begin{align}
...
\begin{align}
  ...
  \\  \CLevBF_{t+2} & = \Mean[\cRat_{t+2}\pLevBF_{t+2}] = \bar{\cRat}_{t+2}\PGro^{2} + \cv_{t+2}(\cRat_{t+2}, \pLevBF_{t+2}) \label{eq:atp2vsatp1}
\end{align}
