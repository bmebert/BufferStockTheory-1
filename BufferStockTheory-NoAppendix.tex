...
% \date{\today}
\renewcommand{\forcedate}{January 2, 2022}\date{\forcedate}
...
For $\hNrm \equiv \lim_{n \rightarrow \infty} \hNrm_{T-n}$ to be finite, we need the \href{{https://\owner.github.io/BufferStockTheory/BufferStockTheory3.html}#FHWC}{Finite Human Wealth Condition}:
\begin{equation}\begin{gathered}\begin{aligned}
...
So, even under \cncl{\FHWC}, the limiting consumer's value for any finite $\mNrm$ will be the sum of two finite numbers: The component due to the unconstrained choice made over the finite horizon leading up to $\bNrm_{t+\tau} = 0$, and the finite component due to the value of consuming all $\PermLvl_{t+\tau}$ thereafter.
...
But
\begin{align*}
  \Ex_{t}[{\PermGroFac}_{t+1} {\underline{\cNrm}}_{t+1}/\bar{\cNrm_{t}}] \leq \Ex_{t}[{\PermGroFac}_{t+1} {\cNrm}_{t+1}/\cNrm_{t}] \leq \Ex_{t}[{\PermGroFac}_{t+1} {\bar{\cNrm}}_{t+1}/\underline{\cNrm}_{t}]
\end{align*}
and
