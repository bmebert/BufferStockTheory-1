...
disarticulate and describe every separate step:\hypertarget{DBCParts}{}
...
question `if the consumer had an extra unit of resources, how much more spending would occur.' 
...
\PGro$.\footnote{Rewrite~\eqref{eq:FVAC} as
  \begin{align*}
...
% \subsection{Proofs}\label{subsec:StabilityProofs}
