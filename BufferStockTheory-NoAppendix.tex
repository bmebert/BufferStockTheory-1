...
% \date{\today}
\renewcommand{\forcedate}{January 19, 2022}\date{\forcedate}
  ...
  \parbox{0.9\textwidth}{
    \begin{center}
      \begin{tabbing}
        ...
        \texttt{~~~~~~PDF:~} \> \> \texttt{\href{https://github.com/\owner/BufferStockTheory/LaTeX/blob/master/BufferStockTheory.pdf}{BufferStockTheory.pdf}} \\ 
        \texttt{~~~Slides:~} \> \> \texttt{\href{https://github.com/\owner/BufferStockTheory/LaTeX/blob/master/BufferStockTheory-Slides.pdf}{BufferStockTheory-Slides.pdf}} \\
...
We now examine implications of possible configurations of the conditions.  (Tables~\ref{table:Comparison} and~\ref{table:Required} (and appendix~\ref{sec:ApndxLiqConstr}) codify.)
