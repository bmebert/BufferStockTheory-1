  ...
  \parbox{0.9\textwidth}{
    \begin{center}
      \begin{tabbing}
        ...
        \texttt{~~~~~~PDF:~} \> \> \texttt{\href{https://github.com/\owner/BufferStockTheory/blob/LaTeX/master/BufferStockTheory.pdf}{BufferStockTheory.pdf}} \\ 
        \texttt{~~~Slides:~} \> \> \texttt{\href{https://github.com/\owner/BufferStockTheory/blob/LaTeX/master/BufferStockTheory-Slides.pdf}{BufferStockTheory-Slides.pdf}} \\
