...
% Extra standardized packages for specilized content
...
% econtexSetup sets boolean Web=true if compilation type is dvi
\ifthenelse{\boolean{Web}}{}{   % 
  \usepackage{scrlayer-scrpage} % Package for page headers
}
...
\pagebreak
\ifthenelse{\boolean{showPageHead}}{}{% Web version has no page headers
