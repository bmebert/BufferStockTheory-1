\input{./econtexRoot} % Set paths (like, \LaTeXInputs) for various resources
...
\usepackage{\LaTeXInputs/\texname-Shortcuts}% Styling for whole paper (and subfiles)
\begin{document}

% Redefine command from \texname.sty file 
% This lets any submaterial called from here it is not standalone
% So that if it IS standalone, e.g., it can make a bibliography
\renewcommand{\onlyinsubfile}[1]{}\renewcommand{\notinsubfile}[1]{#1}

\subfile{BufferStockTheory-NoAppendix} % Main body of paper

\pagebreak
\ifthenelse{\boolean{Web}}{}{\chead[Appendices]{Appendices}}
\appendix
\hypertarget{Appendices}{} % Allows link to [url-of-paper]#Appendices
% \ifthenelse{\boolean{Web}}{% Web
%   \section{Appendices}}{   % PDF
%   %\section[nonumber=true]{Appendices}
% }
