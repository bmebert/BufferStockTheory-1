...
\\ (\GIC) Growth Impatience Condition & $\PatPGro$ & $<$ & 1 & $\cLvl/\pLvl$ $\downarrow$ over time
\end{tabular}
...
\begin{eqnarray}
 \lim_{\mNrm_{t} \rightarrow \infty} \Ex_{t}\left[\frac{\mNrm_{t+1}}{\mNrm_{t}}\right] & = & \PatPGroAdj  \label{eq:mGrowth}
\end{eqnarray}
