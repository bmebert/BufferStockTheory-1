  ...
  \begin{table}
    ...
    \sbox{\Tbl}{
      \begin{tabular}{|c|ccl|c|}
        ...
        \href{https://\owner.github.io/BufferStockTheory\#FHWFacDefn}{Finite Human Wealth Factor}                 & $\RNrm^{-1}$ & $\equiv$ & $\PermGroFac/\Rfree$                    & 0.990 \\
        \href{https://\owner.github.io/BufferStockTheory\#VAFacDefn}{PF Value of Autarky Factor} & $\beth$ & $\equiv$ & $\DiscFac \PermGroFac^{1-\CRRA}$                    & 0.932 \\
