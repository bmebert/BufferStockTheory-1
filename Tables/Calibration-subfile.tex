...
\providecommand{\Tbl}{}\providecommand{\TblName}{}
  ...
  \begin{table}
    ...
    \sbox{\Tbl}{
      \begin{tabular}{|c|ccl|c|}
        ...
        \href{https://\owner.github.io/BufferStockTheory\#FHWFDefn}{Finite Human Wealth Factor}                 & $\RNrm^{-1}$ & $\equiv$ & $\PermGroFac/\Rfree$                    & 0.990 \\
        \href{https://\owner.github.io/BufferStockTheory\#PFVAFacDefn}{PF Value of Autarky Factor} & $\beth$ & $\equiv$ & $\DiscFac \PermGroFac^{1-\CRRA}$                    & 0.932 \\
        ...
        \href{https://\owner.github.io/BufferStockTheory\#uInvEuPermShk}{Utility Compensated Permanent Shock}                & $\uInvEuPermShk $ & $\equiv$ & $ (\Ex[\PermShk^{1-\CRRA}])^{1/(1-\CRRA)}$ & 0.990 \\
        ...
        \href{https://\owner.github.io/BufferStockTheory\#VAFDefn}{Value of Autarky Factor}         & $\DiscAltuAdj $ & $\equiv$ & $ \DiscFac \PermGroFac^{1-\CRRA}\uInvEuPermShk^{1-\CRRA}$       & 0.941 \\ 
