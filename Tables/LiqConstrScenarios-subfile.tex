...
\\ ~~~~ and \RIC~          & $        {\APFac/\Rfree}$ & $        {~<~}1\phantom{~<~}$ & $\phantom{\APFac/\PermGroFac}$  & ~~~\FHWC~holds ($\Rfree > \PermGroFac$); $\cnstr{\cFunc}(\mNrm) = \bar{\cFunc}(\mNrm)$ for $\mNrm \geq 1$ % & $\{\Rfree,\Discount, \PermGroFac \} = $
\\ ~~~~ and \cncl{\RIC}   & $\phantom{\APFac/\Rfree}$ & $\phantom{~<~}1        {~<~}$ & $        {\APFac/\Rfree}$ & ~~~~$\cnstr{\cFunc}(\mNrm)$ is degenerate: $\cnstr{\cFunc}(\mNrm)=0$  %&
\\ \GICRaw~            & $        {\APFac/\PermGroFac}$ & $        {~<~}1\phantom{~<~}$ & $\phantom{\APFac/\Rfree}$  & Constraint binds in finite time for any $\mNrm$ % &
...
$\beta \PermGroFac^{1-\CRRA} < 1$                                                 & $\beta \PermGroFac^{1-\CRRA}\Ex[\pshk^{1-\CRRA}] < 1$  \\
