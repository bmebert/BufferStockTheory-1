...
%    \\\multicolumn{1}{|r|}{ Reference            }                                                                         &                                         & \multicolumn{1}{c|}{Logic}
    ...
    \\
\multicolumn{1}{|r|}{\href{https://\owner.github.io/BufferStockTheory\#PF-Constrained-Solution}{Section~\ref{subsec:PFCon}:}}                &                                         & $\cnstr{\cFunc}(\mRat)=\bar{\cFunc}(\mRat)$ for $\mRat > \mRat_{\#} < 1$
    \\                                                                                                                        &                                         & (\cncl{\RIC} would yield $\mRat_{\#}=0$ so $\cnstr{\cFunc}(\mRat)=0$)
%  \\ \cline{2-3} \href{https://\owner.github.io/BufferStockTheory\#ApndxLiqConstr}{Appendix~\ref{sec:ApndxLiqConstr}} & \GICRaw,\RIC                            & $\lim_{\mRat \rightarrow \infty} \cnstr{\cRat}(\mRat)=\bar{\cRat}(\mRat), \lim_{\mRat \rightarrow \infty} \cnstr{\MPCFunc}(\mRat)=\MinMPC$
    \\ \cline{2-3}  \multicolumn{1}{|r|}{\href{https://\owner.github.io/BufferStockTheory\#ApndxLiqConstr}{Appendix~\ref{sec:ApndxLiqConstr}}:} & \GICRaw,\RIC                            & $\lim_{\mRat \rightarrow \infty} \cnstr{\cRat}(\mRat)=\bar{\cRat}(\mRat), \lim_{\mRat \rightarrow \infty} \cnstr{\MPCFunc}(\mRat)=\MinMPC$                                                                                                                                                                       
    \\                                                                                                                        &                                         & kinks where horizon to $b=0$ changes$^{\ast}$
    \\ \cline{2-3}\multicolumn{1}{|r|}{\href{https://\owner.github.io/BufferStockTheory\#ApndxLiqConstr}{Appendix~\ref{sec:ApndxLiqConstr}}:}  & \GICRaw,\cncl{\RIC}                     & $\lim_{\mRat \rightarrow \infty}  \cnstr{\MPCFunc}(\mRat)=0$
    \\                                                                                                                        &                                         & kinks where horizon to $b=0$ changes$^{\ast}$
...
%   \\ {~Section~\ref{subsec:onetarget}}                                                                             &                                         & \GIC~$\Rightarrow \exists $ `individual steady-state' $\mBalLvl$
...
\\  \multicolumn{1}{|r|}{Figure~\ref{fig:Inequalities}:}                                        &                                 & \FVAC~is stronger than \PFFVAC~
  ...
  \\ \multicolumn{1}{|r|}{Section~\ref{subsubsec:mSteadyState}:}                                        &                                 & \phantom{-Nrm}{\GIC} $\Rightarrow \exists 0 < \mBalLvl < \infty$ %: Steady-State
