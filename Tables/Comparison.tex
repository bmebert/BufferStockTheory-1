...
\multirow{4}{75mm}{\thead{For an unconstrained PF consumer, the \\ ratio of $\cLvl$ to $\pLvl$ will fall over time.  For \\ constrained, guarantees the constraint \\ eventually binds. Guarantees \\ ~~~~~~$\lim_{\mNrm_{t}\uparrow\infty} \Ex_{t}[\pShk_{t+1}\mNrm_{t+1}/\mNrm_{t}] = \PatPGro$}} &
