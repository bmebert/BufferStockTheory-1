...
GICModFailsButGICRawHolds =     IndShockConsumerType(**GICModFailsButGICRawHolds_params,
...
Rfree, DiscFac, CRRA, PermGroFac =     Pars.Rfree, Pars.DiscFac, Pars.CRRA, Pars.PermGroFac

color_cons, color_mrktLev, color_mrktNrm, color_perm, color_mLogGroExp =     "blue", "red", "green", "black", "orange"
...
# Create the agent
HWRichButReturnPatientPFConstrainedAgent =     PerfForesightConsumerType(**PFGICRawHoldsFHWCFailsRICFails_par,
                              quietly=True
                              )
