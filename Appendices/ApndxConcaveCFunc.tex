...
\onlyinsubfile{\externaldocument{\LaTeXGenerated/Endo}} % Get xrefs -- esp to appendix -- from main file; only works properly if main file has already been compiled;
\begin{document}
...
%\href{https://econ-ark.github.io/Endo/Appendices/ApndxEuclidian.pdf}{A brief supplemental appendix} demonstrates that convergence in $\boundFunc$-bounded space implies convergence in Euclidian space.
