...
\begin{equation}\begin{gathered}\begin{aligned}
  ...
  % \\   \mathbb{C}_{t-n}^{t}  & = \cNrm_{t-n}(1+\GPFacRaw/\RNrm+ \cdots + (\GPFac/\RNrm)^{n}) \notag
...
which with a bit of algebra\footnote{
  ...
  \begin{equation}\begin{gathered}\begin{aligned}
    \left(\frac{\GPFacRaw^{-n}}{\GPFac^{-n}/(1-\RPFac) - (1-\RNrm^{-1}\RNrm^{-n})/(1-\RNrm^{-1})}\right)  & = \left(\frac{1}{1/(1-\RPFac) + \RNrm^{-n}\RNrm^{-1}/(1-\RNrm^{-1})}\right)
