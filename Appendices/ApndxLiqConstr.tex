...
resources to the next period at return $\Rfree$:\footnote{The point at
  ...
  \Discount \uFunc^{\prime}(\PGro)$ which is $\cNrm_{\#} =
...
$\cNrm$ must have been growing according to $\PatPGro$, so consumption $n$ periods in the past must have been
\begin{equation}\begin{gathered}\begin{aligned}
  \cNrm_{\#}^{n}  & = \PatPGro^{-n} \cNrm_{t} = \PatPGro^{-n}. \label{eq:cPreHist}
\end{aligned}\end{gathered}\end{equation}

The PDV of consumption from $t-n$ until $t$ can thus be computed as
\begin{equation}\begin{gathered}\begin{aligned}
  \mathbb{C}_{t-n}^{t}  & = \cNrm_{t-n}(1+\Pat/\Rfree+ \cdots + {(\Pat/\Rfree)}^{n}) \notag
  % \\   \mathbb{C}_{t-n}^{t}  & = \cNrm_{t-n}(1+\PatPGro/\Rnorm+ \cdots + (\PatPGro/\Rnorm)^{n}) \notag
  \\  & = \cNrm_{\#}^{n}(1+\PatR+ \cdots + \PatR^{n}) \notag
...
\begin{equation}\begin{gathered}\begin{aligned}
  \lim_{m \rightarrow \infty} \cnstr{\pmb{\MPC}}(\mNrm)  & = 1-\PatR.
\end{aligned}\end{gathered}\end{equation}
...
What is happening here is that the $\cNrm_{\#}^{n}$ term is increasing backward in time at rate dominated in the limit by $\PGro/\Pat$ while the $\bNrm_{\#}$ term is increasing at a rate dominated by $\PGro/\Rfree$ term and
\begin{eqnarray}
  \PGro/\Rfree & > & \PGro/\Pat 
\end{eqnarray}
...
\begin{comment}
  ...
  \begin{equation}\begin{gathered}\begin{aligned}
    \lim_{n \rightarrow \infty} \Rnorm^{n}\bNrm_{\#}^{n}  & =  \left(\frac{-\PatR}{1-\PatR}\right) - \Rnorm^{n}\left(\frac{1-\Rnorm^{-1}\Rnorm^{-n}}{1-\Rnorm^{-1}}\right) %\label{eq:bPoundLim}
  ...
  \begin{equation}\begin{gathered}\begin{aligned}
    \bNrm + \left(\frac{1}{1-\Rnorm^{-1}}\right)  & = \Rnorm^{-\hat{n}}\left(\frac{-\PatR}{1-\PatR} + \frac{-\Rnorm^{-1}}{1-\Rnorm^{-1}}\right)
    \\ \log \left(\bNrm + \left(\frac{1}{1-\Rnorm^{-1}}\right)\right)  & = -\hat{n} \log \Rnorm + \log \left(\frac{-\PatR}{1-\PatR} + \frac{-\Rnorm^{-1}}{1-\Rnorm^{-1}}\right)
    \\ \frac{\log \left(\frac{-\PatR}{1-\PatR} + \frac{-\Rnorm^{-1}}{1-\Rnorm^{-1}}\right)-\log \left(\bNrm + \left(\frac{1}{1-\Rnorm^{-1}}\right)\right)}{\log \Rnorm }  & = \hat{n}
  \end{aligned}\end{gathered}\end{equation}
