...
\begin{align*}
  \bar{\Rnorm}\left(1-\cFunc^{\prime}({\mNrm}_t)\right) - 1 & <  \bar{\Rnorm}(1-\underbrace{(1-\PatR)}_{\MinMPC}) - 1  \\
                                                            ...
                                                            & = \underbrace{\Ex_{t}\left[\frac{\Pat}{\PGro \pShk}\right]}_{= \PatPermGroFacAdj} - 1 
\end{align*}
which is negative because the {\GICNrm} says $\PatPermGroFacAdj < 1$.  
...
\begin{align*}
  \overbrace{\Ex_{t}\left[\frac{\Pat}{\PGro \pShk}\right]}^{\PatPermGroFacAdj} & < 1 < \overbrace{\frac{\Pat}{\Rfree}}^{{\PatR}},
\end{align*}
