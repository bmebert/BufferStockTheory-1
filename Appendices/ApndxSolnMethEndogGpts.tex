...
\begin{equation}\begin{gathered}\begin{aligned}
  ...
  \cFunc_{t+1}(\Rnorm_{t+1}\vec{\aNrm} + \TranShk_{t+1}))] \label{eq:cEulerEndog}
...
\begin{equation}\begin{gathered}\begin{aligned}
\uPP(\cEndFunc_{t})\cEndFunc_{t}^{\aNrm}  & = \Rfree \beta \Ex_{t}[\uPP(\PermGroFac_{t+1} \cFunc_{t+1})\PermGroFac_{t+1} \cFunc^{\mNrm}_{t+1}\Rnorm_{t+1}] \notag
...
Note further that
\begin{equation}\begin{gathered}\begin{aligned}
  \sFunc_{t}^{\prime}(\mNrm)  & = \MinMPC_{t} - \MPC_{t}(\mNrm).
\end{aligned}\end{gathered}\end{equation}
