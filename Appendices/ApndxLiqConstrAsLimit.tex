...
$\cnstr{\cFunc}_{t}(\mRat)$.  We will henceforth refer to this as the
...
\begin{equation}\begin{gathered}\begin{aligned}
  \lim_{\pZero \downarrow 0} \cFunc_{t}(\mRat;\pZero)  & = \cnstr{\cFunc}_{t}(\mRat). \label{eq:RestrEqUnrestr} 
...
\begin{equation}\begin{gathered}\begin{aligned}
  \cnstr{\aFunc}^{*}_{T-1}(\mRat)  & = \underset{\aRat}{\arg \max} \left\{\uFunc(\mRat-\aRat) +  \int_{\underline{\tShkEmp}}^{\bar{\tShkEmp}} \vFunc_{T}(a+\tShkEmp) d\CDF_{\tShkEmp} \right\}. \label{eq:vUnconstr}
\end{aligned}\end{gathered}\end{equation}
...
\begin{equation}\begin{gathered}\begin{aligned}
  \uP(\mRat-\aRat)  & =  \cnstr{\mathfrak{v}}_{T-1}^{\prime}(a) \label{eq:uPConstr}.
%
\end{aligned}\end{gathered}\end{equation}

$\cnstr{\aFunc}_{T-1}^{*}(\mRat)$ therefore answers the question ``With what
...
restrained consumer's actual asset position will be
 \begin{equation}\begin{gathered}\begin{aligned}
  \cnstr{\aFunc}_{T-1}(\mRat)  & = \max[0,\cnstr{\aFunc}^{*}_{T-1}(\mRat)], \notag
\end{aligned}\end{gathered}\end{equation}
...
Deaton~\citeyearpar{deatonLiqConstr}) that
 \begin{equation}\begin{gathered}\begin{aligned}
  \mRat^{1}_{\#}  & = {\left( \cnstr{\mathfrak{v}}_{T-1}^{\prime}(0)\right)}^{-1/\CRRA} \notag
 \end{aligned}\end{gathered}\end{equation}
...
\cnstr{\aFunc}_{T-1}^{*}(\mRat)$.  That is, for any fixed value of
...
$\cnstr{\aFunc}_{T-1}^{*}(\mRat) < 0$, and we showed earlier that
$\lim_{\pZero  \downarrow 0} \aFunc_{T-1}^{*}(\mRat;\pZero) = \cnstr{\aFunc}_{T-1}^{*}(\mRat)$.  So,
