...
factors are $\DiscFac = \Rfree = \PermGroFac = 1$, and there are no permanent
shocks, $\PermShk=1$; the results below are easily generalized
...
between the two problems is that our formula~\eqref{\localorexternallabel{eq:MPCmaxDef}} for the maximal marginal
